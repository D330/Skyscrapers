        ...
        RetrofitClient.getApi().forumTopics(sectionId, page)
                ...
                .success(new SourceCallback() {
                    ...
                    public void onResponse(Source doc) {
                        ...
                        for (Element topicElement : doc.select("ul.frm>li")) {
                        ...
                        Elements moderatorElements = doc.select("div.m5>span>span:has(span.user)");
                        ...
                        listener.onResponse(section, doc.pagination());
                    }
                });
    }
}
